...
___CSS_LOADER_EXPORT___.push([module.id, `section {
    flex-grow: 1;
    margin-left: clamp(280px, 20vw, 20vw);;
}
...
.main .invisible {
    opacity: 0;
}`, "",{"version":3,"sources":["webpack://./src/styles/section.css"],"names":[],"mappings":"AAAA;IACI,YAAY;IACZ,qCAAqC;AACzC;;AAEA,WAAW;;AAEX;IACI,iBAAiB;IACjB,iBAAiB;IACjB,gBAAgB;IAChB,kBAAkB;IAClB,kBAAkB;AACtB;;AAEA,WAAW;;AAEX;IACI,UAAU;IACV,YAAY;IACZ,eAAe;IACf,aAAa;;IAEb,mBAAmB;IACnB,6BAA6B;AACjC;;AAEA;IACI,sBAAsB;IACtB,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,mBAAmB;AACvB;;AAEA;IACI,OAAO;IACP,aAAa;IACb,mBAAmB;IACnB,QAAQ;AACZ;;AAEA;IACI,WAAW;IACX,iBAAiB;AACrB;;AAEA;IACI,OAAO;IACP,aAAa;IACb,oBAAoB;IACpB,kBAAkB;AACtB;;AAEA;IACI,mBAAmB;IACnB,YAAY;AAChB;;AAEA,iBAAiB;;AAEjB;IACI,UAAU;AACd","sourcesContent":["section {\n    flex-grow: 1;\n    margin-left: clamp(280px, 20vw, 20vw);;\n}\n\n/* TITLE  */\n\nsection h1 {\n    font-weight: bold;\n    font-size: 2.8rem;\n    margin-top: 80px;\n    margin-left: 150px;\n    margin-bottom: 1em;\n}\n\n/* TASKS  */\n\n.line {\n    width: 80%;\n    margin: auto;\n    margin-top: 1em;\n    padding: 15px;\n\n    padding-bottom: 1em;\n    border-bottom: 2px solid #eee;\n}\n\n.line:hover {\n    background-color: #eee;\n    border-radius: 10px;\n}\n\n.line .main {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n}\n\n.line .task {\n    flex: 1;\n    display: flex;\n    align-items: center;\n    gap: 1em;\n}\n\n.task p {\n    color: gray;\n    text-wrap: nowrap;\n}\n\n.line .priority {\n    flex: 1;\n    display: flex;\n    justify-content: end;\n    margin-right: 5rem;\n}\n\n.line .due-date {\n    margin-left: 3.5rem;\n    color: green;\n}\n\n/* DELETE ICON  */\n\n.main .invisible {\n    opacity: 0;\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
.projects-list button:hover, .sort-options button:hover {
    background-color: #eee;
...
.new-task:hover {
    background-color: rgb(20, 250, 20, 10%);
    border-radius: 10px 0px 0px 10px;
...
.new-project:hover {
    background-color: rgb(250, 20, 20, 5%);
    border-radius: 10px 0px 0px 10px;
...
.project-item .invisible {
    opacity: 0;
}`, "",{"version":3,"sources":["webpack://./src/styles/nav.css"],"names":[],"mappings":"AAAA;IACI,aAAa;IACb,aAAa;IACb,sBAAsB;IACtB,QAAQ;IACR,aAAa;IACb,kCAAkC;IAClC,+BAA+B;IAC/B,eAAe;IACf,gBAAgB;AACpB;;AAEA,aAAa;;AAEb;IACI,aAAa;IACb,QAAQ;IACR,mBAAmB;IACnB,mBAAmB;IACnB,mCAAmC;AACvC;;AAEA;IACI,sBAAsB;IACtB,kBAAkB;AACtB;;AAEA,WAAW;;AAEX;IACI,aAAa;IACb,mBAAmB;IACnB,QAAQ;IACR,WAAW;IACX,kBAAkB;IAClB,oBAAoB;AACxB;;AAEA;IACI,kBAAkB;IAClB,kCAAkC;AACtC;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,UAAU;IACV,kBAAkB;IAClB,qBAAqB;AACzB;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,QAAQ;IACR,cAAc;AAClB;;AAEA,cAAc;;AAEd;IACI,aAAa;IACb,WAAW;IACX,mBAAmB;IACnB,QAAQ;IACR,kBAAkB;IAClB,oBAAoB;AACxB;;AAEA;IACI,kBAAkB;IAClB,oCAAoC;AACxC;;AAEA;IACI,aAAa;IACb,QAAQ;IACR,mBAAmB;IACnB,WAAW;IACX,cAAc;AAClB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,UAAU;AACd;;AAEA;IACI,gBAAgB;AACpB;;AAEA,YAAY;;AAEZ;IACI,sBAAsB;IACtB,gCAAgC;IAChC,sCAAsC;IACtC,iBAAiB;IACjB,qBAAqB;AACzB;;AAEA;IACI,uCAAuC;IACvC,gCAAgC;IAChC,6BAA6B;IAC7B,iBAAiB;IACjB,YAAY;AAChB;;AAEA;IACI,sCAAsC;IACtC,gCAAgC;IAChC,2BAA2B;IAC3B,iBAAiB;IACjB,UAAU;AACd;;AAEA,iBAAiB;;AAEjB;IACI,iBAAiB;AACrB;;AAEA;IACI,UAAU;AACd","sourcesContent":["nav {\n    height: 100vh;\n    display: flex;\n    flex-direction: column;\n    gap: 1em;\n    padding: 20px;\n    background-color: rgb(251,249,247);\n    width: clamp(280px, 20vw, 20vw);\n    position: fixed;\n    padding-right: 0;\n}\n\n/* PROFILE  */\n\nnav .profile {\n    display: flex;\n    gap: 1em;\n    align-items: center;\n    padding-bottom: 1em;\n    /* border-bottom: 3px solid gray; */\n}\n\nnav .profile img {\n    border: 2px solid #ddd;\n    border-radius: 50%;\n}\n\n/* TASKS  */\n\nnav .new-task {\n    display: flex;\n    align-items: center;\n    gap: 1em;\n    width: 100%;\n    margin-bottom: 1em;\n    padding: 0.8em 0.5em;\n}\n\nnav .new-task img {\n    border-radius: 50%;\n    background-color: rgb(20, 250, 20);\n}\n\nnav .sort-options {\n    display: flex;\n    flex-direction: column;\n    gap: 0.2em;\n    margin-left: 0.5em;\n    padding-bottom: 1.5em;\n}\n\nnav .sort-options img {\n    max-width: 1.5em;\n}\n\nnav .sort-options button {\n    display: flex;\n    align-items: center;\n    gap: 1em;\n    padding: 0.8em;\n}\n\n/* PROJECTS  */\n\nnav .new-project {\n    display: flex;\n    width: 100%;\n    align-items: center;\n    gap: 1em;\n    margin-bottom: 1em;\n    padding: 0.8em 0.5em;\n}\n\nnav .new-project img {\n    border-radius: 50%;\n    background-color: rgb(255, 150, 150);\n}\n\nnav .projects-list button {\n    display: flex;\n    gap: 1em;\n    align-items: center;\n    width: 100%;\n    padding: 0.8em;\n}\n\nnav .projects-list {\n    display: flex;\n    flex-direction: column;\n    gap: 0.2em;\n}\n\nnav .projects-list img {\n    max-width: 1.5em;\n}\n\n/* HOVERS  */\n\n.projects-list button:hover, .sort-options button:hover {\n    background-color: #eee;\n    border-radius: 10px 0px 0px 10px;\n    border-right: 5px solid cornflowerblue;\n    font-weight: bold;\n    color: cornflowerblue;\n}\n\n.new-task:hover {\n    background-color: rgb(20, 250, 20, 10%);\n    border-radius: 10px 0px 0px 10px;\n    border-right: 5px solid green;\n    font-weight: bold;\n    color: green;\n}\n\n.new-project:hover {\n    background-color: rgb(250, 20, 20, 5%);\n    border-radius: 10px 0px 0px 10px;\n    border-right: 5px solid red;\n    font-weight: bold;\n    color: red;\n}\n\n/* DELETE ICONS */\n\n.delete-project {\n    margin-left: auto;\n}\n\n.project-item .invisible {\n    opacity: 0;\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
__webpack_require__.d(__webpack_exports__, {
  jx: () => (/* binding */ addTaskstoProjects),
  Gv: () => (/* binding */ manualReload),
  dt: () => (/* binding */ projects),
  vB: () => (/* binding */ tasks)
});
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./src/styles/dialogs.css
var dialogs = __webpack_require__(87);
...
var dialogs_update = injectStylesIntoStyleTag_default()(dialogs/* default */.A, dialogs_options);
...
const folder_namespaceObject = __webpack_require__.p + "f7c64a1d3dc027508ca4.svg";
...
function displayProjects(index) {
    for (let i = index; i < projects.length; i++) {
        ...
        folderImage.src = folder_namespaceObject;
...
function populateTaskInfoDialog(task) {
    ...
    currentStatus ? statusIcon.src = check_circle_namespaceObject : statusIcon.src = radiobox_blank_namespaceObject;
    ...
    if (comparator < 0) {
        ...
        distance.textContent = formatDistance_formatDistance(task.dueDate, new Date()) + ' ago';
    } else {
        taskDueDate.style.color = 'green';
        distance.textContent = 'In ' + formatDistance_formatDistance(task.dueDate, new Date());
    }
...
function displayProjectSelect(selector) {
    ...
    taskInfoButton.forEach(task => {
        task.addEventListener('click', () => {
            ...
            inputCheckbox.addEventListener('click', () => {
                ...
                targetTask.status ? inputCheckbox.src = check_circle_namespaceObject : inputCheckbox.src = radiobox_blank_namespaceObject;
            })
